...
const INDIA_LAND_POLYGON: Array<[number, number]> = [
  [8.1, 76.5], [10.5, 76.0], [13.0, 74.5], [16.0, 73.5], [19.5, 72.5],
  [22.5, 68.5], [26.5, 69.5], [30.5, 73.5], [34.5, 74.5], [37.0, 77.0],
  [36.5, 81.0], [35.5, 85.0], [35.0, 89.0], [31.0, 92.0], [29.5, 96.0],
  [27.0, 95.0], [25.0, 92.5], [23.0, 90.0], [21.5, 88.0], [19.0, 86.5],
  [17.0, 83.5], [14.0, 81.5], [11.5, 80.0], [8.1, 77.5],
];
